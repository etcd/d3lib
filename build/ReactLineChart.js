  ...
  "node_modules/math-expression-evaluator/src/lexer.js"(exports, module) {
    ...
    Mexp.addToken = function(newTokens) {
      for (var i2 = 0; i2 < newTokens.length; i2++) {
        var x2 = newTokens[i2].token.length;
        var temp = -1;
        ...
        for (var y2 = 0; y2 < newAr[x2].length; y2++) {
          if (newTokens[i2].token === newAr[x2][y2]) {
    ...
    function tokenize(string) {
      ...
      for (var i2 = 0; i2 < length; i2++) {
        ...
        key = "";
        for (x2 = string.length - i2 > newAr.length - 2 ? newAr.length - 1 : string.length - i2; x2 > 0; x2--) {
          if (newAr[x2] === void 0)
            continue;
          for (y2 = 0; y2 < newAr[x2].length; y2++) {
            if (match(string, newAr[x2][y2], i2, x2)) {
              key = newAr[x2][y2];
              y2 = newAr[x2].length;
              x2 = 0;
            }
...
function Group(_ref) {
  var _ref$top = _ref.top, top = _ref$top === void 0 ? 0 : _ref$top, _ref$left = _ref.left, left = _ref$left === void 0 ? 0 : _ref$left, transform2 = _ref.transform, className = _ref.className, children2 = _ref.children, innerRef = _ref.innerRef, restProps = _objectWithoutPropertiesLoose(_ref, _excluded);
  return /* @__PURE__ */ import_react.default.createElement("g", _extends({
    ref: innerRef,
...
function createColorInterpolator(interpolate) {
  ...
  var type2 = interpolate.type, gamma2 = interpolate.gamma;
  var interpolator = interpolatorMap[type2];
  ...
  if ("nice" in config && typeof config.nice !== "undefined" && "nice" in scale) {
    ...
    if (typeof nice === "boolean") {
      ...
      if (typeof nice === "string") {
        ...
        var interval2 = nice.interval, step = nice.step;
        var parsedInterval = (isUtc ? utcIntervals[interval2] : localTimeIntervals[interval2]).every(step);
...
function Line(_ref) {
  ...
  return /* @__PURE__ */ import_react2.default.createElement("line", _extends2({
    ref: innerRef,
...
function LinePath(_ref) {
  var children2 = _ref.children, _ref$data = _ref.data, data = _ref$data === void 0 ? [] : _ref$data, x2 = _ref.x, y2 = _ref.y, _ref$fill = _ref.fill, fill = _ref$fill === void 0 ? "transparent" : _ref$fill, className = _ref.className, curve = _ref.curve, innerRef = _ref.innerRef, _ref$defined = _ref.defined, defined = _ref$defined === void 0 ? function() {
    return true;
  ...
  if (children2)
    return /* @__PURE__ */ import_react3.default.createElement(import_react3.default.Fragment, null, children2({
      path: path2
    }));
  return /* @__PURE__ */ import_react3.default.createElement("path", _extends3({
    ref: innerRef,
...
// node_modules/@visx/text/esm/hooks/useText.js
var _excluded4 = ["verticalAnchor", "scaleToFit", "angle", "width", "lineHeight", "capHeight", "children", "style"];
...
function useText(props) {
  ...
  var wordsByLines = (0, import_react4.useMemo)(function() {
    if (isXOrYNotValid) {
      return [];
    }
    if (width || scaleToFit) {
  ...
  var startDy = (0, import_react4.useMemo)(function() {
  ...
  var transform2 = (0, import_react4.useMemo)(function() {
    var transforms = [];
    if (isXOrYNotValid) {
      return "";
    }
...
// node_modules/@visx/text/esm/Text.js
var _excluded5 = ["dx", "dy", "textAnchor", "innerRef", "innerTextRef", "verticalAnchor", "angle", "lineHeight", "scaleToFit", "capHeight", "width"];
function _extends4() {
...
function Text(props) {
  var _props$dx = props.dx, dx = _props$dx === void 0 ? 0 : _props$dx, _props$dy = props.dy, dy = _props$dy === void 0 ? 0 : _props$dy, _props$textAnchor = props.textAnchor, textAnchor = _props$textAnchor === void 0 ? "start" : _props$textAnchor, innerRef = props.innerRef, innerTextRef = props.innerTextRef, verticalAnchor = props.verticalAnchor, angle = props.angle, _props$lineHeight = props.lineHeight, lineHeight = _props$lineHeight === void 0 ? "1em" : _props$lineHeight, _props$scaleToFit = props.scaleToFit, scaleToFit = _props$scaleToFit === void 0 ? false : _props$scaleToFit, capHeight = props.capHeight, width = props.width, textProps = _objectWithoutPropertiesLoose5(props, _excluded5);
  ...
  return /* @__PURE__ */ import_react5.default.createElement("svg", {
    ...
    fontSize,
    style: SVG_STYLE
  }, wordsByLines.length > 0 ? /* @__PURE__ */ import_react5.default.createElement("text", _extends4({
    ref: innerTextRef,
    transform: transform2
  }, textProps, {
    textAnchor
  }), wordsByLines.map(function(line2, index) {
    return /* @__PURE__ */ import_react5.default.createElement("tspan", {
      key: index,
      x: x2,
...
function getLabelTransform(_ref) {
  ...
  if (orientation === orientation_default.top || orientation === orientation_default.bottom) {
    ...
    y2 = sign * (tickLength + labelOffset + tickLabelFontSize + yBottomOffset);
  } else {
    x2 = sign * ((Number(range[0]) + Number(range[range.length - 1])) / 2);
...
function Ticks(_ref) {
  ...
  return ticks2.map(function(_ref2) {
    ...
    return /* @__PURE__ */ import_react6.default.createElement(Group, {
      key: "visx-tick-" + value + "-" + index,
      className: (0, import_classnames4.default)("visx-axis-tick", tickClassName),
      transform: tickTransform
    }, !hideTicks && /* @__PURE__ */ import_react6.default.createElement(Line, _extends5({
      from,
      to,
      stroke: tickStroke,
      strokeWidth,
      ...
      y: tickYCoord,
      formattedValue
    })) : /* @__PURE__ */ import_react6.default.createElement(Text, _extends5({
      x: to.x,
      y: tickYCoord
...
function AxisRenderer(_ref) {
  ...
  var allTickLabelProps = ticks2.map(function(_ref2) {
    ...
    return tickLabelProps(value, index, ticks2);
  });
  ...
  return /* @__PURE__ */ import_react7.default.createElement(import_react7.default.Fragment, null, ticksComponent({
    hideTicks,
    horizontal,
    orientation,
    scale,
    ...
    strokeWidth,
    tickLineProps
  }), !hideAxisLine && /* @__PURE__ */ import_react7.default.createElement(Line, {
    className: (0, import_classnames5.default)("visx-axis-line", axisLineClassName),
    from: axisFromPoint,
    to: axisToPoint,
    stroke,
    strokeWidth,
    strokeDasharray
  }), label && /* @__PURE__ */ import_react7.default.createElement(Text, _extends6({
    className: (0, import_classnames5.default)("visx-axis-label", labelClassName)
  }, getLabelTransform({
    labelOffset,
    labelProps,
    orientation,
...
// node_modules/@visx/axis/esm/axis/Axis.js
var _excluded6 = ["children", "axisClassName", "hideAxisLine", "hideTicks", "hideZero", "left", "numTicks", "orientation", "rangePadding", "scale", "tickFormat", "tickLength", "tickValues", "top"];
function _extends8() {
...
function Axis(_ref) {
  ...
  return /* @__PURE__ */ import_react8.default.createElement(Group, {
    className: (0, import_classnames6.default)("visx-axis", axisClassName),
    top,
    left
  }, children2(_extends8({}, restProps, {
    axisFromPoint,
    axisToPoint,
    hideAxisLine,
    hideTicks,
...
function useMeasure() {
  var _a = (0, import_react10.useState)(null), element = _a[0], ref = _a[1];
  var _b = (0, import_react10.useState)(defaultState), rect = _b[0], setRect = _b[1];
  var observer = (0, import_react10.useMemo)(function() {
    return new window.ResizeObserver(function(entries) {
      if (entries[0]) {
        var _a2 = entries[0].contentRect, x2 = _a2.x, y2 = _a2.y, width = _a2.width, height = _a2.height, top_1 = _a2.top, left = _a2.left, bottom = _a2.bottom, right = _a2.right;
        setRect({ x: x2, y: y2, width, height, top: top_1, left, bottom, right });
      }
    });
  }, []);
...
// source/lib/ReactLineChart.tsx
var import_jsx_runtime = __toESM(require_jsx_runtime());
var ReactLineChart = (props) => {
  const {
    // data
    data,
    getX,
  ...
  const [ref, { width }] = useMeasure_default();
